import{j as o}from"./jsx-runtime-BnHmloXs.js";import{r as h}from"./index-D0o6aRj1.js";import{g as _,S as x,a as k}from"./storybook-hTxjENzG.js";import{S as P}from"./ContentCard-B9rvYITY.js";import{u as O,a as A}from"./index-KWMf7Mex.js";import{u as J}from"./hooks-CGa2Drq3.js";import{C as X}from"./ContentGrid-CPpdwSTK.js";import"./jsx-runtime-BEh3FTX5.js";import"./add-base-path-DO53KZED.js";import"./index-C8V3Szb0.js";import"./index-C-LDafp8.js";function G({className:t,...e}){return o.jsx("div",{className:`flex flex-col gap-16 ${t??""}`,"data-component":"StorybookContainer",...e})}G.__docgenInfo={description:`Storybook 컨테이너 template 컴포넌트 반환 메서드

@param {StorybookContainerProps} param0: StorybookContainerProps

@returns {React.JSX.Element} JSX`,methods:[],displayName:"StorybookContainer"};function R({disabled:t,onEnd:e,children:p,...g}){const[f,n]=h.useState(null);return J(f,a=>{a.isIntersecting&&(e==null||e())},{rootMargin:"0px 0px 20px 0px"}),o.jsxs("div",{"data-component":"InfiniteScroll",...g,children:[p,p!==void 0&&t!==!0?o.jsx("div",{className:"w-full",ref:n}):null]})}R.__docgenInfo={description:`무한 스크롤 organism 컴포넌트 반환 메서드

@param {InfiniteScrollProps} param0: InfiniteScrollProps

@returns {React.JSX.Element} JSX`,methods:[],displayName:"InfiniteScroll",props:{disabled:{required:!1,tsType:{name:"boolean"},description:"비활성화 여부"},onEnd:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"스크롤이 마지막에 도달할 경우의 이벤트 핸들러"}},composes:["DetailedHTMLProps"]};function c({list:t,pageSize:e=6,loading:p,...g}){const f=O(),n=A(),a=Number.parseInt(n.get("page")??"1",10),y=n.getAll("category"),b=n.get("keyword")??void 0,i=h.useMemo(()=>t==null?void 0:t.filter(({meta:r,summary:S})=>{let s=r.publish;return y.length>0&&(s=s&&y.includes(r.category)),b!==void 0&&(s=s&&S.includes(b.toLowerCase())),s}).map(({meta:r,url:S})=>({category:r.category,description:r.excerpt,href:S,tags:r.tag,thumbnail:r.coverImage,timestamp:r.date,title:r.title,type:r.type})),[t,y,b]),I=h.useMemo(()=>i==null?void 0:i.slice(0,a*e),[e,i,a]),$=()=>{const r=new URLSearchParams(window.location.search);r.set("page",`${a+1}`),f.replace(`${window.location.pathname}?${r.toString()}`,{scroll:!1})},D=(I??[]).length>=(i??[]).length;return o.jsx(R,{"data-component":"ContentInfiniteGrid",disabled:D,onEnd:$,...g,children:o.jsx(X,{list:I,loading:p})})}c.__docgenInfo={description:`컨텐츠 무한 스크롤 그리드 organism 컴포넌트
...
}`,...(j=(L=u.parameters)==null?void 0:L.docs)==null?void 0:j.source}}};const te=["Playground","PageSize","Loading"];export{u as Loading,d as PageSize,m as Playground,te as __namedExportsOrder,ee as default};

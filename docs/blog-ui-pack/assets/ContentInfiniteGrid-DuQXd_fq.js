import{r as p,a as S,j as s,c as w}from"./iframe-pDCEjUij.js";import{C as I}from"./ContentGrid-KU3zJPld.js";function m({disabled:r,onEnd:n,children:t,...a}){const[i,l]=p.useState(null);return S(i,c=>{c.isIntersecting&&(n==null||n())},{rootMargin:"0px 0px 100px 0px"}),s.jsxs("div",{"data-component":"InfiniteScroll",...a,children:[t,t!==void 0&&r!==!0?s.jsx("div",{className:"w-full",ref:l}):null]})}m.__docgenInfo={description:`무한 스크롤 organism 컴포넌트 반환 메서드

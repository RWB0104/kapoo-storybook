import{j as e}from"./iframe-DIrS4rnj.js";import{g as x,S as u,a as c}from"./storybook-CWpip0ZO.js";import{S as i}from"./StorybookTemplate-D0mmKJO6.js";import{C as o}from"./ContentForm-SETQdzdn.js";import"./index-DhvoB8oL.js";import"./utils-jAU0Cazi.js";import"./index-DGlsa-Ho.js";import"./index-BBQLOLHq.js";import"./index-D_ldaswd.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,r="ContentForm",v={argTypes:{className:c("className",r),defaultValue:{control:"text",table:{category:r,subcategory:u.PROP}},id:c("id",r),onChange:{control:{disable:!0},table:{category:r,subcategory:u.EV,type:{detail:"(e: React.FormEvent<HTMLFormElement>) => void",summary:"React.FormEventHandler<HTMLFormElement>"}}},onSubmit:{control:{disable:!0},table:{category:r,subcategory:u.EV,type:{detail:"(data: ContentFormParams, e?: React.BaseSyntheticEvent) => void",summary:"SubmitHandler<HTMLFormElement>"}}}},component:o,parameters:x("컨텐츠 폼 컴포넌트",["컨텐츠 폼 컴포넌트입니다.","키워드를 입력하여 원하는 키워드에 맞는 컨텐츠를 필터링합니다."],{nextjs:{appDirectory:!0}}),tags:["autodocs"],title:"organism/ContentForm"},a={args:{onChange:l("onChange"),onSubmit:l("onSubmit")}},n={argTypes:{defaultValue:{control:{disable:!0}}},render:t=>e.jsxs(i,{subtitle:"기본 파라미터 값이 적용된 예시",title:"DefaultValue",children:[e.jsx(o,{...t,defaultValue:"test"}),e.jsx(o,{...t,defaultValue:"react"}),e.jsx(o,{...t,defaultValue:"typescript"})]})},s={render:t=>e.jsx(i,{subtitle:"변경 이벤트가 적용된 예시 (Actions 탭 참조)",title:"OnChange",children:e.jsx(o,{...t,onChange:l("onChange")})})},m={render:t=>e.jsx(i,{subtitle:"서브밋 이벤트가 적용된 예시 (Actions 탭 참조)",title:"OnSubmit",children:e.jsx(o,{...t,onSubmit:l("onSubmit")})})};var p,d,b;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {

import{j as t}from"./jsx-runtime-BnHmloXs.js";import{r as a}from"./index-D0o6aRj1.js";import{g as p,a as g}from"./storybook-hTxjENzG.js";import{t as h,P as l}from"./theme-BtfOoVWW.js";import"./jsx-runtime-BEh3FTX5.js";function c({children:d}){const{themeState:o,setThemeState:s}=h();return a.useLayoutEffect(()=>{const r=localStorage.getItem("theme");(r==="light"||r==="dark")&&s(r)},[s]),a.useLayoutEffect(()=>{document.body.classList.remove("light","dark"),document.body.classList.add(o)},[o]),t.jsx(t.Fragment,{children:d})}c.__docgenInfo={description:`테마 프로바이더 organism 컴포넌트 반환 메서드

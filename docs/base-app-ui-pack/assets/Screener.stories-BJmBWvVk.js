import{a as Oe,b as Ue,c as Ve,d as He,e as Je,f as Ke,g as Ge,h as Xe,i as ze,k as Be,l as Fe,m as We,n as Qe,j as t}from"./iframe-kt_NS53u.js";import{r as Ye,S as d,u as Ze}from"./Screener-CeL9eYpB.js";import{g as et,S as be,a as Z}from"./storybook-CWpip0ZO.js";import{c as tt}from"./utils-Dwu9H4VD.js";/**
 * @license lucide-react v0.477.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rt=[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71",key:"1cjeqo"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",key:"19qd67"}]],st=tt("Link",rt);var U={exports:{}},V={exports:{}},he;function ot(){return he||(he=1,function(r,e){Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"useIntersection",{enumerable:!0,get:function(){return W}});const n=Oe(),P=Ue(),c=typeof IntersectionObserver=="function",q=new Map,S=[];function B(h){const f={root:h.root||null,margin:h.rootMargin||""},N=S.find(m=>m.root===f.root&&m.margin===f.margin);let u;if(N&&(u=q.get(N),u))return u;const y=new Map,p=new IntersectionObserver(m=>{m.forEach(g=>{const _=y.get(g.target),L=g.isIntersecting||g.intersectionRatio>0;_&&L&&_(L)})},h);return u={id:f,observer:p,elements:y},S.push(f),q.set(f,u),u}function F(h,f,N){const{id:u,observer:y,elements:p}=B(N);return p.set(h,f),y.observe(h),function(){if(p.delete(h),y.unobserve(h),p.size===0){y.disconnect(),q.delete(u);const g=S.findIndex(_=>_.root===u.root&&_.margin===u.margin);g>-1&&S.splice(g,1)}}}function W(h){let{rootRef:f,rootMargin:N,disabled:u}=h;const y=u||!c,[p,m]=(0,n.useState)(!1),g=(0,n.useRef)(null),_=(0,n.useCallback)(I=>{g.current=I},[]);(0,n.useEffect)(()=>{if(c){if(y||p)return;const I=g.current;if(I&&I.tagName)return F(I,o=>o&&m(o),{root:f==null?void 0:f.current,rootMargin:N})}else if(!p){const I=(0,P.requestIdleCallback)(()=>m(!0));return()=>(0,P.cancelIdleCallback)(I)}},[y,N,f,p,g.current]);const L=(0,n.useCallback)(()=>{m(!1)},[]);return[_,p,L]}(typeof e.default=="function"||typeof e.default=="object"&&e.default!==null)&&typeof e.default.__esModule>"u"&&(Object.defineProperty(e.default,"__esModule",{value:!0}),Object.assign(e.default,e),r.exports=e.default)}(V,V.exports)),V.exports}var H={exports:{}},ge;function nt(){return ge||(ge=1,function(r,e){Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"getDomainLocale",{enumerable:!0,get:function(){return n}}),Ve();function n(P,c,q,S){return!1}(typeof e.default=="function"||typeof e.default=="object"&&e.default!==null)&&typeof e.default.__esModule>"u"&&(Object.defineProperty(e.default,"__esModule",{value:!0}),Object.assign(e.default,e),r.exports=e.default)}(H,H.exports)),H.exports}var ye;function at(){return ye||(ye=1,function(r,e){"use client";Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"default",{enumerable:!0,get:function(){return re}});const n=He(),P=Je(),c=n._(Oe()),q=Ke(),S=Ge(),B=Xe(),F=ze(),W=Be(),h=Fe(),f=ot(),N=nt(),u=We(),y=Ye(),p=new Set;function m(o,k,v,i){if(!(typeof window>"u")&&(0,S.isLocalURL)(k)){if(!i.bypassPrefetchedCheck){const C=typeof i.locale<"u"?i.locale:"locale"in o?o.locale:void 0,j=k+"%"+v+"%"+C;if(p.has(j))return;p.add(j)}o.prefetch(k,v,i).catch(C=>{})}}function g(o){const v=o.currentTarget.getAttribute("target");return v&&v!=="_self"||o.metaKey||o.ctrlKey||o.shiftKey||o.altKey||o.nativeEvent&&o.nativeEvent.which===2}function _(o,k,v,i,C,j,$,Q){const{nodeName:Y}=o.currentTarget;if(Y.toUpperCase()==="A"&&(g(o)||!(0,S.isLocalURL)(v)))return;o.preventDefault(),(()=>{const A=$??!0;"beforePopState"in k?k[C?"replace":"push"](v,i,{shallow:j,locale:Q,scroll:A}):k[C?"replace":"push"](i||v,{scroll:A})})()}function L(o){return typeof o=="string"?o:(0,B.formatUrl)(o)}const re=c.default.forwardRef(function(k,v){let i;const{href:C,as:j,children:$,prefetch:Q=null,passHref:Y,replace:se,shallow:oe,scroll:A,locale:M,onClick:ne,onMouseEnter:ae,onTouchStart:le,legacyBehavior:x=!1,...we}=k;i=$,x&&(typeof i=="string"||typeof i=="number")&&(i=(0,P.jsx)("a",{children:i}));const s=c.default.useContext(h.RouterContext),ce=Q!==!1,{href:T,as:b}=c.default.useMemo(()=>{if(!s){const me=L(C);return{href:me,as:j?L(j):me}}const[l,E]=(0,q.resolveHref)(s,C,!0);return{href:l,as:j?(0,q.resolveHref)(s,j):E||l}},[s,C,j]),ie=c.default.useRef(T),ue=c.default.useRef(b);let a;x&&(a=c.default.Children.only(i));const $e=x?a&&typeof a=="object"&&a.ref:v,[de,fe,pe]=(0,f.useIntersection)({rootMargin:"200px"}),Ae=c.default.useCallback(l=>{(ue.current!==b||ie.current!==T)&&(pe(),ue.current=b,ie.current=T),de(l)},[b,T,pe,de]),De=(0,y.useMergedRef)(Ae,$e);c.default.useEffect(()=>{s&&(!fe||!ce||m(s,T,b,{locale:M}))},[b,T,fe,M,ce,s==null?void 0:s.locale,s]);const D={ref:De,onClick(l){!x&&typeof ne=="function"&&ne(l),x&&a.props&&typeof a.props.onClick=="function"&&a.props.onClick(l),s&&(l.defaultPrevented||_(l,s,T,b,se,oe,A,M))},onMouseEnter(l){!x&&typeof ae=="function"&&ae(l),x&&a.props&&typeof a.props.onMouseEnter=="function"&&a.props.onMouseEnter(l),s&&m(s,T,b,{locale:M,priority:!0,bypassPrefetchedCheck:!0})},onTouchStart:function(E){!x&&typeof le=="function"&&le(E),x&&a.props&&typeof a.props.onTouchStart=="function"&&a.props.onTouchStart(E),s&&m(s,T,b,{locale:M,priority:!0,bypassPrefetchedCheck:!0})}};if((0,F.isAbsoluteUrl)(b))D.href=b;else if(!x||Y||a.type==="a"&&!("href"in a.props)){const l=typeof M<"u"?M:s==null?void 0:s.locale,E=(s==null?void 0:s.isLocaleDomain)&&(0,N.getDomainLocale)(b,l,s==null?void 0:s.locales,s==null?void 0:s.domainLocales);D.href=E||(0,u.addBasePath)((0,W.addLocale)(b,l,s==null?void 0:s.defaultLocale))}return x?c.default.cloneElement(a,D):(0,P.jsx)("a",{...we,...D,children:i})});(typeof e.default=="function"||typeof e.default=="object"&&e.default!==null)&&typeof e.default.__esModule>"u"&&(Object.defineProperty(e.default,"__esModule",{value:!0}),Object.assign(e.default,e),r.exports=e.default)}(U,U.exports)),U.exports}var ee,ve;function lt(){return ve||(ve=1,ee=at()),ee}var ct=lt();const it=Qe(ct);function w({className:r,...e}){return t.jsx("div",{className:`flex flex-col gap-16 ${r??""}`,"data-component":"StorybookContainer",...e})}w.__docgenInfo={description:`Storybook 컨테이너 template 컴포넌트 반환 메서드
...
}`,...(Ee=(Me=z.parameters)==null?void 0:Me.docs)==null?void 0:Ee.source}}};const ht=["Playground","All","Video","Image","Stop"];export{K as All,X as Image,J as Playground,z as Stop,G as Video,ht as __namedExportsOrder,bt as default};

import{j as e}from"./jsx-runtime-B-QetEgW.js";import{r as t}from"./iframe-aG7r3vjN.js";import{B as o}from"./Button-DINr_mw0.js";import{c as k}from"./utils-jAU0Cazi.js";import{I as j}from"./Img-CZqzMzw3.js";import{Z as w}from"./ZoomPanner-CziFtJ5g.js";import{X as z}from"./x-B9xfZZUs.js";import{c as m}from"./createLucideIcon-DLvQ1QgS.js";import{M}from"./minus-CnS5WyOh.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]],T=m("RefreshCw",N);function I({src:d="",open:n,dimType:u="blur",onClose:r,onZoomChange:p,onZoomIn:s,onZoomOut:i,onReset:l,...f}){const[a,v]=t.useState(),h=t.useCallback(()=>{r==null||r()},[r]),g=t.useCallback(()=>{a.zoomIn(),s==null||s()},[a,s]),y=t.useCallback(()=>{a.zoomOut(),i==null||i()},[a,i]),b=t.useCallback(()=>{a.reset(),l==null||l()},[a,l]);return t.useLayoutEffect(()=>{document.body.style.overflow=n===!0?"hidden":""},[n]),t.useEffect(()=>{const c=x=>{x.key==="Escape"&&(r==null||r())};return window.addEventListener("keydown",c),()=>{window.removeEventListener("keydown",c)}},[r]),t.useLayoutEffect(()=>{n===!0&&(a==null||a.reset())},[n,a]),n===!0?e.jsxs("div",{className:k("fixed top-0 left-0 z-50 size-full",{"bg-black/80":u==="modal","bg-black/80 backdrop-blur-sm":u==="blur"}),"data-component":"ImageModal",...f,children:[e.jsx("div",{className:"absolute top-4 right-4 z-10",children:e.jsx(o,{size:"icon",variant:"link",onClick:h,children:e.jsx(z,{color:"white"})})}),e.jsx(w,{controller:v,onZoomChange:p,children:e.jsx("div",{className:"flex size-full items-center justify-center",children:e.jsx("div",{className:"relative size-4/5",children:e.jsx(j,{alt:d,className:"object-contain drop-shadow-lg",src:d,fill:!0})})})}),e.jsxs("div",{className:"dark absolute right-4 bottom-4 z-10 flex flex-col gap-2",children:[e.jsx(o,{size:"icon",variant:"default",onClick:g,children:e.jsx(E,{})}),e.jsx(o,{size:"icon",variant:"default",onClick:y,children:e.jsx(M,{})}),e.jsx(o,{size:"icon",variant:"default",onClick:b,children:e.jsx(T,{})})]})]}):null}I.__docgenInfo={description:`이미지 모달 organism 컴포넌트 반환 메서드

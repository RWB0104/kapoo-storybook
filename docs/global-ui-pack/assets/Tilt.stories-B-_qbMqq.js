import{j as e}from"./jsx-runtime-BnHmloXs.js";import{r as i}from"./index-BCzbi48b.js";import{g as me,S as j,a as P}from"./storybook-DTn28L93.js";import{S as ue}from"./StorybookContainer-CXD7EHC6.js";import{S as x}from"./StorybookTemplate-h4nRBuW0.js";import{a as X}from"./util-CbDYoOyb.js";import{c as ge}from"./utils-jAU0Cazi.js";import"./jsx-runtime-BEh3FTX5.js";function n({disabled:t,angle:r=30,perspective:T=1400,scale:y=1,scaleTransition:a="0.5s",className:b,onMouseMove:c,onMouseEnter:h,onMouseLeave:S,children:re,...te}){const k=i.useRef(null),s=i.useRef(null),[N,R]=i.useState(!1),se=i.useCallback(o=>{if(c==null||c(o),t!==!0&&k.current&&s.current){const $=k.current.getBoundingClientRect(),le=o.clientX-$.left,oe=o.clientY-$.top,A=o.currentTarget.scrollWidth/2,w=o.currentTarget.scrollHeight/2,ce=A-le,ie=w-oe,pe=X(ie/w,2)*r,de=X(ce/A,2)*r;s.current.style.scale=`${y}`,s.current.style.transform=`perspective(${T}px) rotateX(${pe}deg) rotateY(${-de}deg)`}},[r,T,y,t,c]),ne=i.useCallback(o=>{h==null||h(o),t!==!0&&s.current&&(s.current.style.transition=`${a} scale`,R(!0),setTimeout(()=>{R(!1)},50))},[t,a,h]),ae=i.useCallback(o=>{S==null||S(o),t!==!0&&s.current&&(s.current.style.transition=`${a} ease-out`,s.current.style.scale="",s.current.style.transform="")},[t,a,S]);return i.useEffect(()=>{s.current&&(s.current.style.transition=N?`${a} ease`:`${a} scale`)},[N,a]),e.jsx("div",{className:ge("size-full will-change-transform transform-3d",b),"data-component":"Tilt",ref:k,onMouseEnter:ne,onMouseLeave:ae,onMouseMove:se,...te,children:e.jsx("div",{className:"flex size-full",ref:s,children:re})})}n.__docgenInfo={description:`틸트 molecule 컴포넌트 반환 메서드

import{j as r}from"./jsx-runtime-CcAjkvR0.js";import{r as o}from"./iframe-aPIFiJaF.js";import{g as L,S as i}from"./storybook-CWpip0ZO.js";import{S as P}from"./StorybookTemplate-DgDGKC7c.js";import{c as n}from"./utils-jAU0Cazi.js";import{c as R}from"./createLucideIcon-UdJRz3In.js";/**
...
@default 50%`,defaultValue:{value:"'50%'",computed:!1}},firstChildren:{required:!0,tsType:{name:"ReactNode"},description:"처음 DOM"},lastChildren:{required:!0,tsType:{name:"ReactNode"},description:"마지막 DOM"}}};const c="Splitter",A={args:{firstChildren:r.jsx("div",{className:"flex h-96 items-center justify-center p-4",children:"First Dom"}),lastChildren:r.jsx("div",{className:"flex h-96 items-center justify-center p-4",children:"Last Dom"})},argTypes:{defaultFirstSize:{table:{category:c,subcategory:i.PROP}},direction:{table:{category:c,subcategory:i.PROP}},firstChildren:{control:{disable:!0},table:{category:c,subcategory:i.PROP}},lastChildren:{control:{disable:!0},table:{category:c,subcategory:i.PROP}}},component:t,parameters:L("react-query 프로바이더 컴포넌트",["[@tanstack/react-query](https://tanstack.com/query/v5/docs/framework/react/overview)를 사용하기 위한 프로바이더 컴포넌트입니다.","단순 로직을 위한 컴포넌트로, 별도의 디자인이 존재하지 않습니다."]),tags:["autodocs"],title:"molecule/Splitter"},l={},u={argTypes:{direction:{control:{disable:!0}}},render:e=>r.jsxs(P,{container:!0,subtitle:"다양한 방향이 적용된 컴포넌트 예시",title:"Direction",children:[r.jsx(t,{...e}),r.jsx(t,{direction:"vertical",...e})]})},d={argTypes:{defaultFirstSize:{control:{disable:!0}}},render:e=>r.jsxs(P,{container:!0,subtitle:"다양한 비율이 적용된 컴포넌트 예시",title:"DefaultFirstSize",children:[r.jsx(t,{...e,defaultFirstSize:"20%"}),r.jsx(t,{...e,defaultFirstSize:"40%"}),r.jsx(t,{...e}),r.jsx(t,{...e,defaultFirstSize:"60%"}),r.jsx(t,{...e,defaultFirstSize:"80%"})]})};var k,z,b;l.parameters={...l.parameters,docs:{...(k=l.parameters)==null?void 0:k.docs,source:{originalSource:"{}",...(b=(z=l.parameters)==null?void 0:z.docs)==null?void 0:b.source}}};var j,D,F;u.parameters={...u.parameters,docs:{...(j=u.parameters)==null?void 0:j.docs,source:{originalSource:`{
  argTypes: {
    direction: {
      control: {
        disable: true
  ...
  render: props => <StorybookTemplate container subtitle="다양한 방향이 적용된 컴포넌트 예시" title="Direction">
            <Splitter {...props} />
  ...
  render: props => <StorybookTemplate container subtitle="다양한 비율이 적용된 컴포넌트 예시" title="DefaultFirstSize">

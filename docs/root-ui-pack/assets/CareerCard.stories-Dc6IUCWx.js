import{j as e}from"./jsx-runtime-BnHmloXs.js";import"./index-ScFTdtO_.js";import{g as z,S as a,a as y}from"./storybook-CWpip0ZO.js";import{p as u,S as N}from"./StorybookTemplate-BxgOy5-n.js";import{c,a as B,I as F}from"./Img-DIpa46Xz.js";import{S as $}from"./Separator-BGhTKItj.js";import"./jsx-runtime-BEh3FTX5.js";import"./image-context-CDqEfIcg.js";import"./index-WKOeQrpv.js";import"./index-DVaK80wF.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M16 14h.01",key:"1gbofw"}],["path",{d:"M8 18h.01",key:"lrp35t"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M16 18h.01",key:"kzsmim"}]],V=c("CalendarDays",H);function o({name:t,icon:D,dept:M,position:v,job:T,startDate:l,endDate:i,list:S,primaryColor:w,className:q,style:R,...O}){const p=u(l),m=u(i),_=Math.ceil(((i??Date.now())-l)/864e5);return e.jsxs("div",{className:B("relative flex shadow-xl border rounded-xl overflow-hidden",q),"data-component":"CareerCard",style:{backgroundColor:w,...R},...O,children:[e.jsxs("div",{className:"flex-1 bg-background dark:bg-neutral-900 shadow-xl p-4 rounded-r-xl",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"relative bg-neutral-200 dark:bg-neutral-700 rounded-md w-10 h-10 overflow-hidden",children:e.jsx(F,{alt:t,className:"object-cover",src:D,fill:!0})}),e.jsxs("div",{children:[e.jsx("h2",{className:"font-semibold text-lg leading-tight",children:t}),e.jsxs("p",{className:"text-muted-foreground text-sm",children:[M," · ",v]})]})]}),e.jsx($,{className:"my-4"}),e.jsxs("div",{className:"flex items-center gap-2 text-muted-foreground text-sm",children:[e.jsx(V,{className:"w-4 h-4"}),e.jsxs("span",{children:[p.year.text,". ",p.month.text," - ",i===void 0?"재직 중":`${m.year.text}. ${m.month.text}`," | ",_,"일 근무"]})]}),e.jsxs("div",{className:"mt-4",children:[e.jsxs("h3",{className:"flex items-center gap-1 mb-1 font-medium text-foreground text-sm",children:[e.jsx(A,{className:"w-4 h-4"}),e.jsx("span",{children:T})]}),e.jsx("ul",{className:"space-y-1 pl-5 text-muted-foreground text-sm list-disc",children:S.map((E,I)=>e.jsx("li",{children:E},I))})]})]}),e.jsx("div",{className:"flex flex-col justify-center items-center p-6",children:e.jsx(X,{className:"opacity-15 text-black",size:28})})]})}o.__docgenInfo={description:`커리어 카드 molecule 컴포넌트 반환 메서드
